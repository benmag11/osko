...
interface UserMenuProps {
  /** Whether we're on mobile (affects dropdown positioning) */
  isMobile: boolean | undefined
  /** Whether the sidebar is collapsed (shows tooltip when true) */
  isCollapsed: boolean
}

/**
 * User dropdown menu for the activity bar
 * Shows avatar with sign out option
 * Tooltip only visible when sidebar is collapsed
 */
export function UserMenu({ isMobile, isCollapsed }: UserMenuProps) {

...
interface SidebarHeaderProps<TPanelId extends string> {
  /** Sidebar configuration (for dashboard link) */
 ...
 * Links to the dashboard based on sidebar variant
 */
export function SidebarHeader<TPanelId extends string>({
  config,
  sidebar,
}: SidebarHeaderProps<TPanelId>) {
